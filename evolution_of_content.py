...
def app():
    st.title("Evolution of content on Netflix")
    ...
    plt.title('Comparing Ratings for Movies vs TV shows', fontsize=24);
    st.pyplot(fig)
    ...
    st.write("Over 200 million people have subscribed to Netflix, so these ratings are a good barometer of the kind of perverse content popular today for viewing. ")
    ...
    plt.title('Overall TV Shows released ratings',fontsize = 24)
    ...
    plt.title('Overall Movies released ratings',fontsize = 24)
    plt.xlabel('Year',fontsize = 15)
    plt.ylabel('No.of Shows',fontsize = 15)
    plt.legend(loc="upper left")
    st.pyplot(fig)
    
    st.write("From the above graphs we can see a clear trend of increasing TV-MA (mature) content on the platform. 2017 was the year the MA content crossed TV-14 content for TV shows and a similar trend can be seen in 2015 for movies")
    st.write("Let's have a closer look in the trend of content in the USA and India")
    ...
    plt.title('TV shows released in India by ratings',fontsize = 24)
    plt.xlabel('Year',fontsize = 15)
    plt.ylabel('No.of Shows',fontsize = 15)
    plt.legend(loc="upper left")
    st.pyplot(fig)
    ...
    plt.title('Movies released in India by ratings',fontsize = 24)
    plt.xlabel('Year',fontsize = 15)
    plt.ylabel('No.of Shows',fontsize = 15)
    plt.legend(loc="upper left")
    st.pyplot(fig)
    
    st.write("An interesting observations when looking at TV shows and movies avalable in india is that the majority of content was TV-14 (teen) and has only reciently been taken over by MA content. this may have been to appeal to the majority of the indian population that are teenagers .")
    ...
    plt.title('TV shows released in the United States by ratings',fontsize = 24)
    plt.xlabel('Year',fontsize = 15)
    plt.ylabel('No.of Shows',fontsize = 15)
    plt.legend(loc="upper left")
    st.pyplot(fig)
    ...
    plt.title('Movies released in the United States by ratings',fontsize = 24)
    plt.xlabel('Year',fontsize = 15)
    plt.ylabel('No.of Shows',fontsize = 15)
    plt.legend(loc="upper left")
    st.pyplot(fig)
    ...
    st.write("The trend of content in the United States follows the overall trend of content on Netflix for the most part.")
    ...
    plt.title('Growth of original content', fontsize=20);
